                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group ">
                            ...
                            <input type="text" name="username" id="username" placeholder="username" class="form-control"
                                   v-model="classe.username">
                                   <span v-if="errors.username" class="alert-danger">{{errors.username[0]}}</span>
                        </div>
                        <div class="form-group ">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="username" placeholder="username" class="form-control"
                                   v-model="update_classe.username">
                                   <span v-if="errors.username" class="alert-danger">{{errors.username[0]}}</span>
                        </div>
                        <div class="form-group">
                            <label for="phone">phone:</label>
	...
	data(){
		return{
			...
			thead:[
				...
				{title: 'Username', key: 'username', sort: true},
        ...
        operators:{
		 ...
		 methods: {
            ...
            createTask(classe)
            {
                axios.post('http://localhost/stock/public/api/employee', {
                   name: classe.name,
            ...
            {
                axios.patch('http://localhost/stock/public/api/employee/' + update_classe.id, {
			...
			deleteTask(classe)
            {
                ...
                if (conf === true) {
                    ...
                    axios.delete('http://localhost/stock/public/api/employee/' + classe.id)
