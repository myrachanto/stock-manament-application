	...
	data(){
        ...
        operators:{
		 ...
		 methods: {
            ...
            createTask(classe)
            {
                axios.post('http://localhost/stock/public/api/supplier', {
                   name: classe.name,
            ...
            {
                axios.patch('http://localhost/stock/public/api/supplier/' + update_classe.id, {
			...
			deleteTask(classe)
            {
                ...
                if (conf === true) {
                    ...
                    axios.delete('http://localhost/stock/public/api/supplier/' + classe.id)
