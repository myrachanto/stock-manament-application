                    ...
                    <div class="modal-body">
                        <div class="form-group ">
                            ...
                            <input type="text" name="title" id="title" placeholder="title" class="form-control"
                                   v-model="classe.title">
                                   <span v-if="errors.title" class="alert-danger">{{errors.title[0]}}</span>
                        </div>
                        <div class="form-group ">
                            <label for="date">date:</label>
                            <input type="date" name="date" id="date" placeholder="date" class="form-control"
                                   v-model="classe.date">
                                   <span v-if="errors.date" class="alert-danger">{{errors.date[0]}}</span>
                        </div>
                        <div class="form-group ">
                            <label for="due_date">Due date:</label>
                            <input type="date" name="due_date" id="due_date" placeholder="due_date" class="form-control"
                                   v-model="classe.due_date">
                                   <span v-if="errors.due_date" class="alert-danger">{{errors.due_date[0]}}</span>
                        </div>
                        <div class="form-group ">
                            <label for="discount">Discount:</label>
                            <input type="text" name="discount" id="discount" placeholder="discount" class="form-control"
                                   v-model="classe.discount">
                                   <span v-if="errors.discount" class="alert-danger">{{errors.discount[0]}}</span>
                        </div>
                        <div class="form-group">
	...
	data(){
        ...
        operators:{
		 ...
		 methods: {
            ...
            createTask(classe)
            {
                axios.post('http://localhost/stock/public/api/invoice', {
                   name: classe.name,
            ...
            {
                axios.patch('http://localhost/stock/public/api/invoice/' + update_classe.id, {
			...
			deleteTask(classe)
            {
                ...
                if (conf === true) {
                    ...
                    axios.delete('http://localhost/stock/public/api/invoice/' + classe.id)
